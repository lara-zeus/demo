...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'plugins' => 'advlist autoresize codesample directionality fullscreen hr image link lists media table wordcount',
            'toolbar' => 'undo redo removeformat | formatselect fontsizeselect | bold italic | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table toc hr | image link media codesample | wordcount fullscreen',
            'upload_directory' => null,
        ],

        'simple' => [
            'plugins' => 'autoresize directionality link wordcount',
            'toolbar' => 'removeformat | bold italic | rtl ltr | link',
            'upload_directory' => null,
        ],
        ...
        */
        ...
        /*
          'default' => [
            'plugins' => 'advlist autoresize codesample directionality fullscreen hr image imagetools link lists media table toc wordcount',
            'toolbar' => 'undo redo removeformat | formatselect fontsizeselect | bold italic | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table toc hr | image link media codesample | wordcount fullscreen',
            'custom_configs' => [
