...
>
    <button
        ...
        @class([
            ...
            'hover:bg-gray-50 focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-custom-600 dark:hover:bg-white/5 dark:focus-visible:ring-custom-500' => ! $disabled,
