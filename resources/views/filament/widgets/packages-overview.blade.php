<x-filament-widgets::widget>
    <x-filament::section class="space-y-4">
        <h2 class="font-bold text-xl">🔥 Community Packages</h2>
        <p>
            These the plugins we used in this demo, make sure to check them out.
        </p>

        <x-list.index>
            <div class="ltr:pl-3 rtl:pr-3 grid grid-cols-1 md:grid-cols-3 gap-2">
                <x-list.item url="https://github.com/awcodes/recently">
                    ⚡️ Recently Viewed
                </x-list.item>
                ...
                <x-list.item url="https://github.com/awcodes/filament-tiptap-editor">
