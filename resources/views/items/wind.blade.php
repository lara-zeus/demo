<x-item>
    ...
    @slot('btns')
        ...
        <a href="{{ url('wind/contact-us') }}" class="shadow transition ease-in-out whitespace-nowrap text-base font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 px-4 py-2">
            Contact Form
        </a>
    @endslot
</x-item>
