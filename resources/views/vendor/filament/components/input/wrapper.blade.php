...
@php
    ...
    $enabledValidWrapperClasses = 'dark:ring-white/20 [&:not(:has(.fi-ac-action:focus))]:focus-within:ring-custom-600 dark:[&:not(:has(.fi-ac-action:focus))]:focus-within:ring-custom-500';
