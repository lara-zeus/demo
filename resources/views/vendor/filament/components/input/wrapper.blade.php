...
@php
    ...
    $enabledValidWrapperClasses = '[&:not(:has(.fi-ac-action:focus))]:focus-within:ring-custom-600 dark:ring-white/20 dark:[&:not(:has(.fi-ac-action:focus))]:focus-within:ring-custom-500';
