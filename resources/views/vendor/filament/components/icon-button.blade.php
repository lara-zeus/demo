...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...
        match ($color) {
            'gray' => 'fi-color-gray text-gray-400 hover:text-gray-500 focus-visible:ring-custom-600 dark:text-gray-500 dark:hover:text-gray-400 dark:focus-visible:ring-custom-500',
