                            ...
                            {{
                                $getExtraInputAttributeBag()
                                    ->class([
                                        ...
                                        'text-custom-600 ring-gray-950/10 focus:ring-custom-600 checked:focus:ring-custom-500/50 dark:ring-white/20 dark:checked:bg-custom-500 dark:focus:ring-custom-500 dark:checked:focus:ring-custom-400/50 dark:disabled:ring-white/10' => ! $errors->has($statePath),
