                                            ...
                                            <div class="w-full space-y-3">
                                                @foreach ([
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            @class([
                                                                'block w-full border-none text-sm transition duration-75 focus-visible:border-custom-500 focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-custom-500 disabled:opacity-70 dark:bg-gray-700 dark:text-white dark:focus-visible:border-custom-500',
                                                            ])
