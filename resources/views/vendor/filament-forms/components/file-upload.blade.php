                                            ...
                                            <div class="w-full space-y-3">
                                                @foreach ([
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            @class([
                                                                'block w-full border-none text-sm transition duration-75 focus:border-custom-500 focus:ring-1 focus:ring-inset focus:ring-custom-500 disabled:opacity-70 dark:bg-gray-700 dark:text-white dark:focus:border-custom-500',
                                                            ])
